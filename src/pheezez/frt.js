...
export class FRT {
  constructor(provider, networkId, testing, options) {
    ...
    this.frtAddress = contractAddresses.frt[networkId]
    //console.log("TEST2",this.pheezezAddress)
    this.frtPool1Address = contractAddresses.frtPool1[networkId]
    this.daiAddress = contractAddresses.dai[networkId]
    this.frtdaiAddress = contractAddresses.frtdai[networkId]
  }
