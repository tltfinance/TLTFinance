...
export class Pheezez {
  constructor(provider, networkId, testing, options) {
    ...
    this.pheezezAddress = contractAddresses.pheezez[networkId]
    //console.log("TEST2",this.pheezezAddress)
    this.digesterAddress = contractAddresses.digester[networkId]
    this.wethAddress = contractAddresses.weth[networkId]
    this.ethusdAddress = contractAddresses.ethusd[networkId]
    this.pheezezethAddress = contractAddresses.pheezezeth[networkId]
  }
