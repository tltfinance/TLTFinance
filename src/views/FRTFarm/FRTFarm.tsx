...
import { ftruncate } from 'fs/promises'

const FRTFarm: React.FC = () => {
  ...
  return (
    <>
      ...
      <StyledFarm>
        <StyledCardsWrapper>
          ...
          <StyledCardWrapper>
            ...
            <Stake
              ...
              pid={pid}
              tokenName={poolToken.toUpperCase()}
            />
          </StyledCardWrapper>
        </StyledCardsWrapper>
        <Spacer />
        ...
        <Spacer size="lg" />
        <StyledInfo>
         "Whithdraw and Exit" unstakes your tokens and claims your rewards!!!
        </StyledInfo>
        <Spacer size="lg" />
      </StyledFarm>
    </>
